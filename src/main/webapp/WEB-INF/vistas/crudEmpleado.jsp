...
<div class="row" >  
			...
			<div class="col-md-2" >
					<input class="form-control" id="id_txt_filtro"  name="filtro" placeholder="Ingrese el nombres" type="text" maxlength="30"/>
			</div>
			<div class="col-md-2" >
...
<div class="modal fade" id="id_div_modal_registra" > <!-- MODAL: TIENE Q TERMINAR AQUI PARA IR EN EL OTRO -->
...
function agregarGrilla(lista){
	 ...
	 $('#id_table').DataTable({
			...
			lengthChange: false,
			columns:[
				{data: "idEmpleado"}, //Json tiene los atributos de la entidad
				{data: "nombres"},
				{data: "apellidos"},
				...
				{data: function(row, type, val, meta){
					...
					return salida;
				},className:'text-center'},			//ELIMINAR										
			]                                     
	    });
}
